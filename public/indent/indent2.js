...
const GetTodayIndentsCount = async function () {
    await axios.post("/indent/getPendingMyActionAndTodayActionCount", {
        ...
        $("#all-trips-count").html(DOMPurify.sanitize(res.data.allCount))
        $("#today-indent-count").html(DOMPurify.sanitize(res.data.todayCount))
        $("#pending-action-count").html(DOMPurify.sanitize(res.data.pendingMyActionCount))
        $("#reEdit-indent-count").html(DOMPurify.sanitize(res.data.reEditCount))
        $("#fuel-indent-count").html(DOMPurify.sanitize(res.data.fuelCount))
    })
}
